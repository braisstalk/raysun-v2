...
const STATIC_PATHS: Array<{ path: string; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }> = [
  ...
  { path: '/what-science-can-do', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/what-science-can-do/publications', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/what-science-can-do/stories-of-impact', changeFrequency: 'monthly', priority: 0.5 },
